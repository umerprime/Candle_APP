...
class FreeVersionCatholic extends StatefulWidget {
  ...
  FreeVersionCatholic(this.deseased);
          ...
          child: Column(
            children: [
              Container(
                ...
                width: MediaQuery.of(context).size.width * 1,
                //colorDefaultTabController: Colors.red,

                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    ProfilePhoto(widget.deseased, "catholic"),
                    // InkWell(
                    //  onTap: (){
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Unlock(widget.deseased, "catholic"),

                    NormalCalendar(widget.deseased, "catholic"),
                    //    RemindMeByEmail(widget.deseased,"catholic"),

                    PersonalMessage(widget.deseased, "catholic"),
                  ],
                ),
              ),

              Bottom_Navbar("cathelic", widget.deseased),
